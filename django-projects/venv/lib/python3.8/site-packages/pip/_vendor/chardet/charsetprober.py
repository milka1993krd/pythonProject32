...
class CharSetProber:
    ...
    def filter_international_words(buf: Union[bytes, bytearray]) -> bytearray:
        ...
        by markers. This function works to filter.py all words that contain at
        least one international character. All contiguous sequences of markers
        are replaced by a single space ascii character.
        This filter.py applies to all scripts which do not use English characters.
        """
        filtered = bytearray()
    ...
    def remove_xml_tags(buf: Union[bytes, bytearray]) -> bytes:
        ...
        This filter.py can be applied to all scripts which contain both English
